    ...
    if (campaign == null) {
      campaign = [
        ...
        new Puzzle("5x5_cross", AssetPaths.puzzle_5x5_cross__png)
          .setTitle("Gazing Out The Window")
          .setCards(1, 30)
          .setNumWheels(0)
          .setFeatures([])
        ...
        new Puzzle("6x6_landscape", AssetPaths.puzzle_6x6_landscape__png)
          .setTitle("Meadow In Southern France")
          .setCards(2, 15)
          .setNumWheels(0)
          .setFeatures([JUMP])
        ...
        new Puzzle("12x5_red_yellow_blue", AssetPaths.puzzle_12x5_red_yellow_blue__png)
          .setTitle("Who's Afraid Of Hex Values?")
          .setCards(3, 10)
          .setNumWheels(1)
        ...
        new Puzzle("9x9_diamond", AssetPaths.puzzle_9x9_diamond__png)
          .setTitle("Set The Controls For The Heart Of The Sun")
          .setCards(3, 30)
